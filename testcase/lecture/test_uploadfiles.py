...
class TestUploadfiles(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.data = todict.data(os.path.join(os.path.dirname(__file__), '../../data', 'lecture_uploadfiles.json'))
    ...
    def test_uploadfiles(self):
        ...
        try:
            ...
            log.info(f'lecture/test_uploadfiles: FAIL, error is {error}')
        finally:
            self.assertEqual(200, res.status_code)
            log.info('lecture/test_uploadfiles: SUCCESS！')
