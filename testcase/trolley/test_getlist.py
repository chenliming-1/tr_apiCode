...
class TestGetlist(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.data = todict.data(os.path.join(os.path.dirname(__file__), '../../data', 'trolley_getlist.json'))
